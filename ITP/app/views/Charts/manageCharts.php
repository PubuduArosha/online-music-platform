...
<body>
    ...
    <div class="d-flex" id="wrapper" style=" background-color: azure">
           ...
           <div class="row card-container ">
            <div class="col-md-12" >
              ...
              <?php   while($row = $results->fetch_assoc()) {   ?>
                 <a href="<?=PR?>/Charts/editChart/<?=$row['ChartID']?>" >
              ...
              <div class="col-md-2  col-sm-4 col-6 card-wrapper">
                  <div class="col-md-12 card">
                      ...
                      <a href="<?=PR?>/Charts/chartDetails">  <img src="../uploads/charts/AddBtn.png" class="image-add-btn"><br>
                        Add Chart</h3></a>
                  </div>
                </div>
